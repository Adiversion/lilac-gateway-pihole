...
export const LIST_ITEM_LIMIT = isNaN(process.env.CLOUDFLARE_LIST_ITEM_LIMIT)
  ? 300000
  : parseInt(process.env.CLOUDFLARE_LIST_ITEM_LIMIT, 20);

export const LIST_ITEM_SIZE = 1000;

export const API_HOST = "https://api.cloudflare.com/client/v4";

export const DRY_RUN = !!parseInt(process.env.DRY_RUN, 20);

export const FAST_MODE = !!parseInt(process.env.FAST_MODE, 20);
...
export const RECOMMENDED_BLOCKLIST_URLS = [
 ...
 "https://raw.githubusercontent.com/badmojr/1Hosts/master/Xtra/dnsmasq.conf",
 "https://cdn.jsdelivr.net/gh/badmojr/1Hosts@master/Pro/adblock.txt",
 "https://codeberg.org/Magnesium1062/BadBlock/raw/branch/main/abp/badblock_plus.txt",
];
